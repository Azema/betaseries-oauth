"use strict";var DataTypesCache,OrderComments,MediaStatusComments,StarTypes,NetworkState,MediaType,EventTypes,HTTP_VERBS,Picked,MovieStatus,SortTypeSubtitles,SubtitleTypes,SubtitleLanguages,DaysOfWeek,NotifTypes;!function(e){e.shows="shows",e.episodes="episodes",e.movies="movies",e.members="members",e.updates="updateAuto",e.db="db"}(DataTypesCache=DataTypesCache||{});class CacheUS{_data;constructor(){return this._init()}_init(){return this._data={},this._data[DataTypesCache.shows]={},this._data[DataTypesCache.episodes]={},this._data[DataTypesCache.movies]={},this._data[DataTypesCache.members]={},this._data[DataTypesCache.db]={},this}keys(e=null){return e?Object.keys(this._data[e]):Object.keys(this._data)}has(e,t){return void 0!==this._data[e]&&void 0!==this._data[e][t]}clear(e=null){if(e&&void 0!==this._data[e])for(const t in this._data[e])delete this._data[e][t];else this._init();return this}get(e,t){return this.has(e,t)?this._data[e][t]:null}getOrDefault(e,t,s){return this.has(e,t)?this.get(e,t):s}set(e,t,s){return void 0!==this._data[e]&&(this._data[e][t]=s),this}remove(e,t){return this.has(e,t)&&delete this._data[e][t],this}}class Character{actor;description;guest;id;name;picture;role;show_id;movie_id;person_id;constructor(e){this.actor=e.actor||"",this.picture=e.picture||"",this.name=e.name||"",this.guest=!!e.guest||!1,this.id=void 0!==e.id?parseInt(e.id,10):0,this.description=e.description||"",this.role=e.role||"",this.show_id=void 0!==e.show_id?parseInt(e.show_id,10):0,this.movie_id=void 0!==e.movie_id?parseInt(e.movie_id,10):0,this.person_id=void 0!==e.person_id?parseInt(e.person_id,10):0}}class personMedia{show;movie;role;type;constructor(e,t){t===MediaType.show?this.show=new Show(e.show):t===MediaType.movie&&(this.movie=new Movie(e.movie)),this.role=e.name,this.type=t}get media(){return this.type===MediaType.show?this.show:this.type===MediaType.movie?this.movie:void 0}}class Person{static fetch(e){return Base.callApi(HTTP_VERBS.GET,"persons","person",{id:e}).then(e=>e?new Person(e.person):null)}id;name;birthday;deathday;description;last;shows;movies;constructor(t){this.id=void 0!==t.id?parseInt(t.id,10):0,this.name=t.name||"",this.birthday=t.birthday?new Date(t.birthday):null,this.deathday=t.deathday?new Date(t.deathday):null,this.description=t.description||"",this.shows=[];for(let e=0;e<t.shows.length;e++)this.shows.push(new personMedia(t.shows[e],MediaType.show));this.movies=[];for(let e=0;e<t.movies.length;e++)this.movies.push(new personMedia(t.movies[e],MediaType.movie));t.last?.show?this.last=new personMedia(t.last,MediaType.show):t.last?.movie&&(this.last=new personMedia(t.last,MediaType.movie))}}!function(e){e.DESC="desc",e.ASC="asc"}(OrderComments=OrderComments||{}),function(e){e.OPEN="open",e.CLOSED="close"}(MediaStatusComments=MediaStatusComments||{});class CommentsBS{static EventTypes=["update","save","add","added","delete","show"];static sendComment(t,e){e={type:t.mediaType.singular,id:t.id,text:e};return Base.callApi(HTTP_VERBS.POST,"comments","comment",e).then(e=>{e=new CommentBS(e.comment,t.comments);return t.comments.addComment(e),t.comments.is_subscribed=!0,e}).catch(e=>{Base.notification("Commentaire","Erreur durant l'ajout d'un commentaire"),console.error(e)})}comments;nbComments;is_subscribed;status;_parent;_events;_listeners;_order;constructor(e,t){this.comments=[],this._parent=t,this.is_subscribed=!1,this.status=MediaStatusComments.OPEN,this.nbComments=e,this._order=OrderComments.DESC,this._initListeners()}init(){const i=this;function e(){const t=jQuery("#comments .slides_flex .slide_flex .slide__comment");let s;for(let e=0;e<t.length;e++)(s=jQuery(t.get(e))).attr("data-comment-id",i.comments[e].id)}var t;this.comments.length<=0&&0<this.nbComments?(t=jQuery("#comments .slides_flex .slide_flex"),this.fetchComments(t.length).then(e)):e()}_initListeners(){this._listeners={};var t=CommentsBS.EventTypes;for(let e=0;e<t.length;e++)this._listeners[t[e]]=[];return this}addListener(e,t,...s){if(CommentsBS.EventTypes.indexOf(e)<0)throw new Error(e+" ne fait pas partit des events gérés par cette classe");void 0===this._listeners[e]&&(this._listeners[e]=[]);for(const i in this._listeners[e])if(i.toString()==t.toString())return void(Base.debug&&console.warn("Cette fonction est déjà présente pour event[%s]",e));return 0<s.length?this._listeners[e].push({fn:t,args:s}):this._listeners[e].push(t),Base.debug&&console.log("Base[%s] add Listener on event %s",this.constructor.name,e,this._listeners[e]),this}removeListener(t,s){if(void 0!==this._listeners[t])for(let e=0;e<this._listeners[t].length;e++)("function"==typeof this._listeners[t][e]&&this._listeners[t][e].toString()===s.toString()||this._listeners[t][e].fn.toString()==s.toString())&&this._listeners[t].splice(e,1);return this}_callListeners(t){if(void 0!==this._listeners[t]&&0<this._listeners[t].length){var s=new CustomEvent("betaseries",{detail:{name:t}});Base.debug&&console.log("Comments call %d Listeners on event %s",this._listeners[t].length,t);for(let e=0;e<this._listeners[t].length;e++)"function"==typeof this._listeners[t][e]?this._listeners[t][e].call(this,s,this):this._listeners[t][e].fn.apply(this,this._listeners[t][e].args)}return this}get length(){return this.comments.length}get media(){return this._parent}get order(){return this._order}set order(e){this._order=e}fetchComments(i=50,n=0,e=OrderComments.DESC){e!==this._order&&(this.order=e);const a=this;return new Promise((e,t)=>{const s={type:a._parent.mediaType.singular,id:a._parent.id,nbpp:i,replies:0,order:a.order};0<n&&(s.since_id=n),Base.callApi(HTTP_VERBS.GET,"comments","comments",s).then(t=>{if(void 0!==t.comments){n<=0&&(a.comments=[]);for(let e=0;e<t.comments.length;e++)a.comments.push(new CommentBS(t.comments[e],a))}a.nbComments=parseInt(t.total,10),a.is_subscribed=!!t.is_subscribed,a.status=t.status,e(a)}).catch(e=>{console.warn("fetchComments",e),Base.notification("Récupération des commentaires","Une erreur est apparue durant la récupération des commentaires"),t(e)})})}addComment(e){const t=this.order==OrderComments.DESC?Array.prototype.unshift:Array.prototype.push;return Base.debug&&console.log("addComment order: %s - method: %s",this.order,t.name),e instanceof CommentBS?t.call(this.comments,e):t.call(this.comments,new CommentBS(e,this)),this.nbComments++,this.media.nbComments++,Base.debug&&console.log("addComment listeners",this._listeners),this._callListeners(EventTypes.ADD),this}removeComment(t){for(let e=0;e<this.comments.length;e++)if(this.comments[e].id===t){this.comments.splice(e,1),this.removeFromPage(t),this.nbComments--,this.media.nbComments--,this._callListeners("delete");break}return this}isFirst(e){return this.comments[0].id===e}isLast(e){return this.comments[this.comments.length-1].id===e}isOpen(){return this.status===MediaStatusComments.OPEN}getComment(t){for(let e=0;e<this.comments.length;e++)if(this.comments[e].id===t)return this.comments[e];return null}getPrevComment(t){for(let e=0;e<this.comments.length;e++)if(this.comments[e].id===t&&0<e)return this.comments[e-1];return null}getNextComment(t){var s=this.comments.length;for(let e=0;e<this.comments.length;e++)if(this.comments[e].id===t&&e<s-1)return this.comments[e+1];return null}async fetchReplies(e,t=OrderComments.ASC){var s=await Base.callApi(HTTP_VERBS.GET,"comments","replies",{id:e,order:t});const i=[];if(s.comments)for(let e=0;e<s.comments.length;e++)i.push(new CommentBS(s.comments[e],this));return i}changeThumbs(t,s,i){for(let e=0;e<this.comments.length;e++)if(this.comments[e].id===t)return this.comments[e].thumbs=s,this.comments[e].thumbed=i,!0;return!1}async getTemplate(i){const n=this;return new Promise((e,t)=>{let s=Promise.resolve(n);Base.debug&&console.log("Base ",{length:n.comments.length,nbComments:n.nbComments}),n.comments.length<=0&&0<n.nbComments&&(Base.debug&&console.log("Base fetchComments call"),s=n.fetchComments(i)),s.then(async()=>{let t,s=`
                    ...
                    <button type="button" class="btn-reset btnSubscribe" style="position: absolute; top: 3px; right: 31px; padding: 8px;">
                        ...
                        </button>`),s+="</div>",n.isOpen()&&Base.userIdentified()&&(s+=CommentBS.getTemplateWriting()),e(s+"</div>")}).catch(e=>{t(e)})})}getLogins(){const t=[];for(let e=0;e<this.comments.length;e++)t.includes(this.comments[e].login)||t.push(this.comments[e].login);return t}updateCounter(){const e=jQuery("#comments .blockTitle");e.text(e.text().replace(/\d+/,this.nbComments.toString()))}loadEvents(h,u,p){this._events=[];async function m(t){var s=parseInt(t.data("commentId"),10);let i;if(t.hasClass("reply")){let e=t.prev();for(;e.hasClass("reply");)e=e.prev();t=parseInt(e.data("commentId"),10);if(s==t)i=f.getComment(s);else{const n=f.getComment(t);i=await n.getReply(s)}}else i=f.getComment(s);return i}const f=this,s=jQuery("#popin-dialog"),e=jQuery("#popin-showClose"),t=(e.click(()=>{p.hidePopup(),s.removeAttr("data-popin-type")}),this._events.push({elt:e,event:"click"}),h.find(".toggleAllReplies")),i=(t.click(e=>{const t=jQuery(e.currentTarget);e=t.attr("data-toggle");const s=h.find(`.toggleReplies[data-toggle="${e}"]`);"1"==e?(s.trigger("click"),t.attr("data-toggle","0"),t.text("Afficher toutes les réponses")):(s.trigger("click"),t.attr("data-toggle","1"),t.text("Masquer toutes les réponses"))}),this._events.push({elt:t,event:"click"}),h.find(".btnSubscribe"));function n(e){f.is_subscribed?f.is_subscribed&&(e.addClass("active"),e.attr("title","Ne plus recevoir les commentaires par e-mail"),e.find("svg").replaceWith(`
        ...
        `;for(let e=0;e<4;e++)l+=`
            ...
            <div class="slide_flex">
                ...
                <div class="evaluations">
                    <div class="size-base">${this.media.objNote.total} évaluation${1<this.media.objNote.total?"s":""} dont ${n} parmis les commentaires</div>
        ...
        `;for(let e=0;e<4;e++)l+=`
            ...
            `),new Promise((i,n)=>{window.addEventListener("message",function e(t){var s=new URL(Base.serverOauthUrl).origin;if(t.origin!==s)return Base.debug&&console.error("receiveMessage {origin: %s}",t.origin,t),void n("event.origin is not "+s);"access_token"===t.data.message?(Base.token=t.data.value,$("#containerIframe").remove(),i(t.data.message)):(console.error("Erreur de récuperation du token",t),n(t.data),Base.notification("Erreur de récupération du token","Pas de message")),window.removeEventListener("message",e,!1)},!1)})}static callApi(o,l,d,c,h=!1){if(Base.api&&-1===Base.api.resources.indexOf(l))throw new Error(`Ressource (${l}) inconnue dans l'API.`);if(!Base.userKey)throw Base.notification("Call API","La clé API doit être renseignée"),new Error("userKey are required");if(!Base.token&&l in Base.api.tokenRequired&&d in Base.api.tokenRequired[l]&&1!==Base.api.tokenRequired[l][d].indexOf(o))throw Base.notification("Call API",`Identification requise pour cet appel: ${o} ${l}/`+d),new ExceptionIdentification("Identification required");if(Base.networkState===NetworkState.offline){var e=o+l+d;if(Base.__networkQueue[e])return Base.__networkQueue[e];{const s=new fakePromise(()=>Base.callApi(o,l,d,c,h).then(e=>e).catch(e=>e));return Base.__networkQueue[e]=s,Base.__networkQueue[e]}}let i=!1,u=!0;0<=Base.api.notDisplay.indexOf(l+d)?u=!1:Base.showLoader();const p={Accept:"application/json","X-BetaSeries-Version":Base.api.versions.current,"X-BetaSeries-Token":Base.token,"X-BetaSeries-Key":Base.userKey},t=Object.keys(Base.api.check);if(Base.debug&&u&&console.log("Base.callApi",{type:o,resource:l,action:d,args:c,force:h}),Base.cache&&!h&&"GET"===o&&c&&"id"in c&&Base.cache.has(l,c.id))return new Promise(e=>{e(Base.cache.get(l,c.id)),Base.hideLoader()});function n(n,a){const e={method:o,headers:p,mode:"cors",cache:"no-cache"};let r=Base.api.url+`/${l}/`+d;var t=Object.keys(c);if("GET"===o&&0<t.length){const s=[];for(const i of t)s.push(i+"="+encodeURIComponent(c[i]));r+="?"+s.join("&")}else 0<t.length&&(e.body=new URLSearchParams(c));fetch(r,e).then(i=>{Base.counter++,Base.debug&&(u||200!==i.status)&&console.log("fetch (%s %s) response status: %d",o,r,i.status),i.json().then(e=>{var t,s;return Base.debug&&(u||200!==i.status)&&console.log("fetch (%s %s) data",o,r,e),void 0!==e.errors&&0<e.errors.length?(t=e.errors[0].code,s=e.errors[0].text,2005===t||400===i.status&&0===t&&"L'utilisateur a déjà marqué cet épisode comme vu."===s?a("changeStatus"):2001==t?Base.authenticate().then(()=>{Base.callApi(o,l,d,c,h).then(e=>n(e),e=>a(e))},e=>{a(e)}):a(e.errors[0])):i.ok?n(e):(console.error("Fetch erreur network",i),a(i)),void Base.hideLoader()})}).catch(e=>{Base.debug&&console.log("Il y a eu un problème avec l'opération fetch: "+e.message),console.error(e),a(e.message),Base.hideLoader()})}Base.userIdentified()&&-1!==t.indexOf(l)&&-1!==Base.api.check[l].indexOf(d)&&(i=!0);const s=new Promise((t,s)=>{var e;i?(e={method:"GET",headers:p,mode:"cors",cache:"no-cache"},Base.debug&&u&&console.info("%ccall /members/is_active","color:#1d6fb2"),fetch(Base.api.url+"/members/is_active",e).then(e=>{Base.counter++,e.ok?n(t,s):Base.authenticate().then(()=>{p["X-BetaSeries-Token"]=Base.token,n(t,s)}).catch(e=>s(e))}).catch(e=>{Base.debug&&console.log("Il y a eu un problème avec l'opération fetch: "+e.message),console.error(e),s(e.message)})):n(t,s)});return s}static setPropValue(e,t,s){if(0<=t.indexOf(".")){const a=t.split("."),r=a.shift();t=a.join("."),/\[\d+\]$/.test(r)?(i=r.replace(/\[\d+\]$/,""),n=parseInt(r.replace(/[^\d]*/,""),10),Base.setPropValue(e[i][n],t,s)):/\[.*\]$/.test(r)?(i=r.replace(/\[.+\]$/,""),n=r.replace(/^.*\[/,"").replace(/\]$/,""),Base.setPropValue(e[i][n],t,s)):Base.setPropValue(e[r],t,s)}else{var i,n;/\[.*\]$/.test(t)?(i=t.replace(/\[.+\]$/,""),n=t.replace(/^.*\[/,"").replace(/\]$/,""),e[i][n]=s):e[t]=s}}static replaceParams(s,i,n){var a=Object.keys(i);for(let t=0;t<a.length;t++){var r=a[t],o=i[r];if(void 0===n[r])throw new Error(`Parameter[${r}] missing`);let e=n[r];"number"==o?e=parseInt(e,10):"string"==o&&(e=String(e));o=new RegExp(`#${r}#`,"g");s=s.replace(o,e)}return s}static relatedProps={};static selectorsCSS={};static networkState=NetworkState.online;static __networkQueue={};static changeNetworkState(e){if((this.networkState=e)===NetworkState.online&&0<Object.keys(this.__networkQueue).length){for(const t of Reflect.ownKeys(this.__networkQueue)){const s=this.__networkQueue[t].launch();s.finally(()=>delete this.__networkQueue[t])}this.__networkQueue={}}}description;nbComments;id;objNote;resource_url;title;user;characters;comments;mediaType;__initial;__changes;__props;__elt;__listeners;constructor(e){if(e instanceof Object)return this.__initial=!0,this.__changes={},this.characters=[],this.__elt=null,this.__props=["characters","comments","mediaType"],this._initListeners(),this;throw new Error("data is not an object")}[Symbol.iterator](){return{pos:0,props:this.__props,next(){var e;return this.pos<this.props.length?(e={value:this.props[this.pos],done:!1},this.pos++,e):{value:null,done:!(this.pos=0)}}}}fill(i){const r=this;for(const a in this.constructor.relatedProps)if(Reflect.has(i,a)){const o=this.constructor.relatedProps[a];var n=i[a];let e,t=(this.__initial&&(e={configurable:!0,enumerable:!0,get:()=>r["_"+o.key],set:i=>{var n=r["_"+o.key];if(Array.isArray(n)&&n.length===i.length){let s=!1;for(let e=0,t=n.length;e<t;e++)if(n[e]!==i[e]){s=!0;break}if(!s)return}else if("object"==typeof n){let s=!1;var a=Reflect.ownKeys(i).filter(e=>!e.startsWith("_"));for(let e=0,t=a.length;e<t;e++)if(n[a[e]]!==i[a[e]]){s=!0;break}if(!s)return}else if(n===i)return;r["_"+o.key]=i,r.__initial||(r.__changes[o.key]={oldValue:n,newValue:i},r.updatePropRender(o.key))}}),!1),s=void 0;switch(o.type){case"string":s=String(n),t=!0;break;case"number":s=parseInt(n,10),t=!0;break;case"boolean":case"bool":s=!!n,t=!0;break;case"date":s=new Date(n),t=!0;break;case"object":s=Object.assign({},n),t=!0;break;case"array":s=n,t=!0;break;default:"function"==typeof o.type&&n&&((s=Reflect.construct(o.type,[n]))&&Reflect.has(s,"parent")&&(s.parent=r),t=!0)}!t&&null==s&&Reflect.has(o,"default")&&(s=o.default,t=!0),t&&("function"==typeof o.transform&&(s=o.transform(this,null!=n?n:i)),this.__initial?(Object.defineProperty(this,o.key,e),Reflect.set(this,o.key,s),this.__props.push(o.key)):this[o.key]=s)}return this.__initial&&(this.__props.sort(),this.__initial=!1),this.save()}_initRender(){this.elt&&(this.changeTitleNote(!0),this.decodeTitle(),this.objNote.updateStars())}updatePropRender(e){var t;this.elt&&(t="updatePropRender"+e.camelCase().upperFirst(),Reflect.has(this,t)?this[t]():Reflect.has(this.constructor.selectorsCSS,e)&&(t=this.constructor.selectorsCSS[e],jQuery(t).text(this[e].toString()),delete this.__changes[e]))}updatePropRenderNote(){Base.debug&&console.log("updatePropRenderNote"),this.objNote.updateStars(),this.changeTitleNote(!0),this._callListeners(EventTypes.NOTE)}_initListeners(){this.__listeners={};var t=this.constructor.EventTypes;for(let e=0;e<t.length;e++)this.__listeners[t[e]]=[];return this}addListener(e,t,...s){if(this.constructor.EventTypes.indexOf(e)<0)throw new Error(e+" ne fait pas partit des events gérés par cette classe");void 0===this.__listeners[e]&&(this.__listeners[e]=[]);for(const i in this.__listeners[e])if(i.toString()==t.toString())return;return 0<s.length?this.__listeners[e].push({fn:t,args:s}):this.__listeners[e].push(t),Base.debug&&console.log("Base[%s] add Listener on event %s",this.constructor.name,e,this.__listeners[e]),this}removeListener(t,s){if(void 0!==this.__listeners[t])for(let e=0;e<this.__listeners[t].length;e++)("function"==typeof this.__listeners[t][e]&&this.__listeners[t][e].toString()===s.toString()||this.__listeners[t][e].fn.toString()==s.toString())&&this.__listeners[t].splice(e,1);return this}_callListeners(t){if(0<=this.constructor.EventTypes.indexOf(t)&&0<this.__listeners[t].length){Base.debug&&console.log("Base[%s] call %d Listeners on event %s",this.constructor.name,this.__listeners[t].length,t,this.__listeners);var s=new CustomEvent("betaseries",{detail:{name:t}});for(let e=0;e<this.__listeners[t].length;e++)"function"==typeof this.__listeners[t][e]?this.__listeners[t][e].call(this,s,this):this.__listeners[t][e].fn.apply(this,this.__listeners[t][e].args)}return this}init(){return this.elt&&(this.comments=new CommentsBS(this.nbComments,this)),new Promise(e=>e(this))}save(){return Base.cache instanceof CacheUS&&(Base.cache.set(this.mediaType.plural,this.id,this),this._callListeners(EventTypes.SAVE)),this}get elt(){return this.__elt}set elt(e){this.__elt=e}get nbCharacters(){return this.characters.length}decodeTitle(){const e=this.elt.find(".blockInformations__title"),t=e.text();return/&#/.test(t)&&e.text($("<textarea />").html(t).text()),this}changeTitleNote(e=!0){const t=this.elt.find(".js-render-stars");var s;{if(!(this.objNote.mean<=0||this.objNote.total<=0))return s=this.objNote.toString(),e&&t.attr("title",s),s;e&&t.attr("title","Aucun vote")}}addVote(e){const i=this;return new Promise((t,s)=>{Base.callApi(HTTP_VERBS.POST,this.mediaType.plural,"note",{id:this.id,note:e}).then(e=>{i.fill(e[this.mediaType.singular])._callListeners(EventTypes.NOTE),t(!0)}).catch(e=>{Base.notification("Erreur de vote","Une erreur s'est produite lors de l'envoi de la note: "+e),s(e)})})}fetchCharacters(){throw new Error("Method abstract")}getCharacter(e){for(const t of this.characters)if(t.id===e)return t;return null}}const dateFormat=function(){const m=/d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g,f=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,g=/[^-+\dA-Z]/g,v=(e,t=2)=>String(e).padStart(t,"0"),_={default:"ddd dd mmm yyyy HH:MM:ss",datetime:"dd/mm/yyyy HH:MM",shortDate:"d/m/yy",mediumDate:"d mmm yyyy",longDate:"d mmmm yyyy",fullDate:"dddd, d mmmm yyyy",shortTime:"h:MM TT",mediumTime:"h:MM:ss TT",longTime:"h:MM:ss TT Z",isoDate:"yyyy-mm-dd",isoTime:"HH:MM:ss",isoDateTime:"yyyy-mm-dd'T'HH:MM:ss",isoUtcDateTime:"UTC:yyyy-mm-dd'T'HH:MM:ss'Z'"},b={dayNames:{abr:["Dim.","Lun.","Mar.","Mer.","Jeu.","Ven.","Sam."],full:["Dimanche","Lundi","Mardi","Mercredi","Jeudi","Vendredi","Samedi"]},monthNames:{abr:["Jan.","Fev.","Mar.","Avr.","Mai","Juin","Juil.","Août","Sept.","Oct.","Nov.","Dec."],full:["Janvier","Février","Mars","Avril","Mai","Juin","Juillet","Août","Septembre","Octobre","Novembre","Décembre"]}};return function(e,t,s){if(1!=arguments.length||"[object String]"!=Object.prototype.toString.call(e)||/\d/.test(e)||(t=e,e=void 0),e=e?new Date(e):new Date,isNaN(e))throw TypeError("invalid date");"UTC:"==(t=String(_[t]||t||_.default)).slice(0,4)&&(t=t.slice(4),s=!0);const i=s?"getUTC":"get",n=e[i+"Date"](),a=e[i+"Day"](),r=e[i+"Month"](),o=e[i+"FullYear"](),l=e[i+"Hours"](),d=e[i+"Minutes"](),c=e[i+"Seconds"](),h=e[i+"Milliseconds"](),u=s?0:e.getTimezoneOffset(),p={d:n,dd:v(n),ddd:b.dayNames.abr[a],dddd:b.dayNames.full[a],m:r+1,mm:v(r+1),mmm:b.monthNames.abr[r],mmmm:b.monthNames.full[r],yy:String(o).slice(2),yyyy:o,h:l%12||12,hh:v(l%12||12),H:l,HH:v(l),M:d,MM:v(d),s:c,ss:v(c),l:v(h,3),L:v(99<h?Math.round(h/10):h),t:l<12?"a":"p",tt:l<12?"am":"pm",T:l<12?"A":"P",TT:l<12?"AM":"PM",Z:s?"UTC":(String(e).match(f)||[""]).pop().replace(g,""),o:(0<u?"-":"+")+v(100*Math.floor(Math.abs(u)/60)+Math.abs(u)%60,4)};return t.replace(m,function(e){return e in p?p[e]:e.slice(1,e.length-1)})}}(),calculDuration=function(){const a=e=>{const t=new Date(e.getFullYear(),0,0);return Math.floor((e.getTime()-t.getTime())/864e5)},r={yesterday:"Hier",dayBeforeYesterday:"Avant-hier",longTime:"Il y a longtemps",days:"Il y a %days% jours",hours:"Il y a %hours% heures",minutes:"Il y a %minutes% minutes"};return function(e){const t=new Date,s=Math.round(a(t)-a(e));if(0<s)return 1===s?r.yesterday:2===s?r.dayBeforeYesterday:30<s?r.longTime:r.days.replace("%days%",s.toString());{const i=Math.round((t.getTime()-e.getTime())/6e4),n=Math.round((t.getTime()-e.getTime())/36e5);return 0===n&&0<i?r.minutes.replace("%minutes%",i.toString()):0<n?r.hours.replace("%hours%",n.toString()):void 0}}}(),upperFirst=function(e){return e.charAt(0).toUpperCase()+e.slice(1)},camelCase=function(e){return e.replace(/[.,\/#!$%\^&\*;:][{}=\-_`~()]/g,"_").replace(/[^a-zA-Z_]/g,"").split("_").reduce((e,t,s)=>e+(s?t.upperFirst():t.toLowerCase()),"")};Date.prototype.format=function(e,t=!1){return dateFormat(this,e,t)},Date.prototype.duration=function(){return calculDuration(this)},String.prototype.upperFirst=function(){return upperFirst(this)},String.prototype.camelCase=function(){return camelCase(this)};class Media extends Base{static propsAllowedOverride={};static overrideType;static selectorsCSS={genres:".blockInformations .blockInformations__details li:nth-child(#n#) span",duration:".blockInformations .blockInformations__details li:nth-child(#n#) span"};static _fetch(e,t){throw new Error("Abstract Static Method")}static fetchByImdb(e,t=!1){return this._fetch({imdb_id:e},t)}followers;genres;imdb_id;language;duration;original_title;similars;nbSimilars;in_account;slug;__fetches;constructor(e,t){return super(e),t&&(this.elt=t),this.__fetches={},this.similars=[],this.genres=[],this}init(){return this.elt?super.init().then(()=>(this._overrideProps(),this)):super.init()}updatePropRenderGenres(){const e=jQuery(Media.selectorsCSS.genres);0<e.length&&e.text(this.genres.join(", ")),delete this.__changes.genres}fetchSimilars(){return new Promise(e=>e(this))}getSimilar(t){if(!this.similars)return null;for(let e=0;e<this.similars.length;e++)if(this.similars[e].id===t)return this.similars[e];return null}async override(t,s,i){var n=this.constructor;if(n.propsAllowedOverride[t]){const a=await Base.gm_funcs.getValue("override",{shows:{},movies:{}});void 0===a[n.overrideType][this.id]&&(a[n.overrideType][this.id]={}),a[n.overrideType][this.id][t]=s;let e=n.propsAllowedOverride[t].path;return n.propsAllowedOverride[t].params&&(a[n.overrideType][this.id][t]={value:s,params:i},e=Base.replaceParams(e,n.propsAllowedOverride[t].params,i),console.log("override",{prop:t,value:s,params:i,path:e})),Base.setPropValue(this,e,s),await Base.gm_funcs.setValue("override",a),!0}return!1}async _overrideProps(){var s,i=this.constructor,n=i.overrideType,a=await Base.gm_funcs.getValue("override",{shows:{},movies:{}});if(console.log("_overrideProps override",a),a[n][this.id]){console.log("_overrideProps override found",a[n][this.id]);for(const r in a[n][this.id]){let e=i.propsAllowedOverride[r].path,t=a[n][this.id][r];i.propsAllowedOverride[r].params&&"object"==typeof a[n][this.id][r]&&(t=a[n][this.id][r].value,s=a[n][this.id][r].params,e=Base.replaceParams(e,i.propsAllowedOverride[r].params,s)),console.log("_overrideProps prop[%s]",r,{path:e,value:t}),Base.setPropValue(this,e,t)}}return this}_getTvdbUrl(e){const i=Base.serverBaseUrl+"/proxy/",n={method:"GET",headers:{origin:"https://www.betaseries.com","x-requested-with":"",Accept:"application/json"},mode:"cors",cache:"no-cache"};return new Promise((t,s)=>{fetch(i+"?tab=series&id="+e,n).then(e=>e.ok?e.json():s()).then(e=>{e?t(e.url):s()})})}}class Images{static formats={poster:"poster",wide:"wide"};constructor(e){this.show=e.show,this.banner=e.banner,this.box=e.box,this.poster=e.poster,this._local={show:this.show,banner:this.banner,box:this.box,poster:this.poster}}show;banner;box;poster;_local}!function(e){e[e.none=0]="none",e[e.banner=1]="banner",e[e.show=2]="show"}(Picked=Picked||{});class Picture{constructor(e){this.id=parseInt(e.id,10),this.show_id=parseInt(e.show_id,10),this.login_id=parseInt(e.login_id,10),this.url=e.url,this.width=parseInt(e.width,10),this.height=parseInt(e.height,10),this.date=new Date(e.date),this.picked=e.picked}id;show_id;login_id;url;width;height;date;picked}class Platform{constructor(e){this.id=parseInt(e.id,10),this.name=e.name,this.tag=e.tag,this.link_url=e.link_url,this.available=e.available,this.logo=e.logo,this.partner=!e.partner||!1}id;name;tag;link_url;available;logo;partner}class PlatformList{svod;vod;country;static types={svod:"svod",vod:"vod"};static fetchPlatforms(i="us"){return new Promise((t,s)=>{Base.callApi(HTTP_VERBS.GET,"platforms","list",{country:i}).then(e=>{t(new PlatformList(e.platforms,i))}).catch(e=>s(e))})}constructor(t,e="fr"){if(t.svod){this.svod=[];for(let e=0;e<t.svod.length;e++)this.svod.push(new Platform(t.svod[e]));this.svod.sort(function(e,t){return e.name<t.name?-1:e.name>t.name?1:0})}if(t.vod){this.vod=[];for(let e=0;e<t.vod.length;e++)this.vod.push(new Platform(t.vod[e]));this.vod.sort(function(e,t){return e.name<t.name?-1:e.name>t.name?1:0})}this.country=e}renderHtmlOptions(e="svod",t=null){let s="";if(e===PlatformList.types.svod){var i=this.svod.filter(e=>-1===t.indexOf(e.id));for(let e=0;e<i.length;e++)s+=`<option value="${i[e].id}" data-src="${i[e].logo}">${i[e].name}</option>`}else if(e===PlatformList.types.vod){var n=this.vod.filter(e=>-1===t.indexOf(e.id));for(let e=0;e<n.length;e++)s+=`<option value="${n[e].id}" data-src="${n[e].logo}">${n[e].name}</option>`}return s}}class Platforms{constructor(t){if(this.svods=[],t?.svods&&t?.svods instanceof Array)for(let e=0;e<t.svods.length;e++)this.svods.push(new Platform(t.svods[e]));if(t?.svod&&(this.svod=new Platform(t.svod)),this.vod=[],t?.vod&&t?.vod instanceof Array)for(let e=0;e<t.vod.length;e++)this.vod.push(new Platform(t.vod[e]))}svods;svod;vod}class Showrunner{constructor(e){this.id=e.id?parseInt(e.id,10):null,this.name=e.name,this.picture=e.picture}id;name;picture}class Show extends Media{static EventTypes=[EventTypes.UPDATE,EventTypes.SAVE,EventTypes.ADD,EventTypes.ADDED,EventTypes.REMOVE,EventTypes.NOTE,EventTypes.ARCHIVE,EventTypes.UNARCHIVE];static propsAllowedOverride={poster:{path:"images.poster"},season:{path:"seasons[#season#].image",params:{season:"number"}}};static overrideType="shows";static selectorsCSS={title:".blockInformations h1.blockInformations__title",description:".blockInformations p.blockInformations__synopsis",creation:".blockInformations .blockInformations__metadatas time",followers:".blockInformations .blockInformations__metadatas span.u-colorWhiteOpacity05.textAlignCenter:nth-of-type(2)",nbSeasons:".blockInformations .blockInformations__metadatas span.u-colorWhiteOpacity05.textAlignCenter:nth-of-type(3)",nbEpisodes:".blockInformations .blockInformations__metadatas span.u-colorWhiteOpacity05.textAlignCenter:nth-of-type(4)",country:".blockInformations .blockInformations__details li:nth-child(#n#) a",genres:".blockInformations .blockInformations__details li:nth-child(#n#) span",duration:".blockInformations .blockInformations__details li:nth-child(#n#) span",status:".blockInformations .blockInformations__details li:nth-child(#n#) span",network:".blockInformations .blockInformations__details li:nth-child(#n#) span",showrunner:".blockInformations .blockInformations__details li:nth-child(#n#) span"};static relatedProps={aliases:{key:"aliases",type:"object",default:{}},comments:{key:"nbComments",type:"number",default:0},country:{key:"country",type:"string",default:""},creation:{key:"creation",type:"number",default:0},description:{key:"description",type:"string",default:""},episodes:{key:"nbEpisodes",type:"number",default:0},followers:{key:"followers",type:"number",default:0},genres:{key:"genres",type:"array",transform:objToArr,default:[]},id:{key:"id",type:"number"},images:{key:"images",type:Images},imdb_id:{key:"imdb_id",type:"string",default:""},in_account:{key:"in_account",type:"boolean",default:!1},language:{key:"language",type:"string",default:""},length:{key:"duration",type:"number",default:0},network:{key:"network",type:"string",default:""},next_trailer:{key:"next_trailer",type:"string",default:""},next_trailer_host:{key:"next_trailer_host",type:"string",default:""},notes:{key:"objNote",type:Note},original_title:{key:"original_title",type:"string",default:""},platforms:{key:"platforms",type:Platforms},rating:{key:"rating",type:"string",default:""},resource_url:{key:"resource_url",type:"string",default:""},seasons:{key:"nbSeasons",type:"number",default:0},seasons_details:{key:"seasons",type:"array",transform:Show.seasonsDetailsToSeasons},showrunner:{key:"showrunner",type:Showrunner},similars:{key:"nbSimilars",type:"number",default:0},slug:{key:"slug",type:"string",default:""},social_links:{key:"social_links",type:"array",default:[]},status:{key:"status",type:"string",default:""},thetvdb_id:{key:"thetvdb_id",type:"number",default:0},themoviedb_id:{key:"tmdb_id",type:"number",default:0},title:{key:"title",type:"string",default:""},user:{key:"user",type:User}};static seasonsDetailsToSeasons(t,s){const i=[];for(let e=0;e<s.length;e++)i.push(new Season(s[e],t));return i}static _fetch(e,i=!1){return new Promise((t,s)=>{Base.callApi("GET","shows","display",e,i).then(e=>t(new Show(e.show,jQuery(".blockInformations")))).catch(e=>s(e))})}static fetchLastSeen(s=10){return new Promise((e,t)=>{Base.callApi(HTTP_VERBS.GET,"shows","member",{order:"last_seen",limit:s}).then(t=>{const s=[];for(let e=0;e<t.shows.length;e++)s.push(new Show(t.shows[e]));e(s)}).catch(e=>t(e))})}static fetchMulti(i){return new Promise((e,t)=>{Base.callApi(HTTP_VERBS.GET,"shows","display",{id:i.join(",")}).then(t=>{const s=[];if(1<i.length)for(let e=0;e<t.shows.length;e++)s.push(new Show(t.shows[e]));else s.push(new Show(t.show));e(s)}).catch(e=>t(e))})}static fetch(e,t=!1){return Show._fetch({id:e},t)}static fetchByTvdb(e,t=!1){return this._fetch({thetvdb_id:e},t)}static fetchByUrl(e,t=!0){return this._fetch({url:e},t)}aliases;creation;country;_currentSeason;images;markToSee;nbEpisodes;nbSeasons;network;next_trailer;next_trailer_host;rating;persons;pictures;platforms;seasons;showrunner;social_links;status;thetvdb_id;_posters;constructor(e,t){return super(e,t),this.__fetches={},this._posters=null,this.persons=[],this.seasons=[],this.mediaType={singular:MediaType.show,plural:"shows",className:Show},this.fill(e)._initRender()}_initRender(){if(this.elt){super._initRender();const t=jQuery(Show.selectorsCSS.title);var e;0<t.length&&(e=t.text(),t.empty().append(`<span class="title">${e}</span>`),Show.selectorsCSS.title+=" span.title");const n=jQuery(".blockInformations__details li",this.elt);for(let e=0,t=n.length;e<t;e++){const a=jQuery(n.get(e));if(a.get(0).classList.length<=0)switch(a.find("strong").text().trim().toLowerCase()){case"pays":Show.selectorsCSS.country=Show.selectorsCSS.country.replace("#n#",(e+1).toString());break;case"genres":Media.selectorsCSS.genres=Media.selectorsCSS.genres.replace("#n#",(e+1).toString()),Show.selectorsCSS.genres=Show.selectorsCSS.genres.replace("#n#",(e+1).toString());break;case"durée d’un épisode":{Show.selectorsCSS.duration=Show.selectorsCSS.duration.replace("#n#",(e+1).toString());const r=jQuery(Show.selectorsCSS.duration),o=r.text().trim();var s=o.substring(0,o.indexOf(" ")),i=o.substring(o.indexOf(" "));r.empty().append(`<span class="time">${s}</span>`+i),Show.selectorsCSS.duration+=" span.time",Media.selectorsCSS.duration=Show.selectorsCSS.duration;break}case"statut":Show.selectorsCSS.status=Show.selectorsCSS.status.replace("#n#",(e+1).toString());break;case"chaîne":Show.selectorsCSS.network=Show.selectorsCSS.network.replace("#n#",(e+1).toString());break;case"showrunner":Show.selectorsCSS.showrunner=Show.selectorsCSS.showrunner.replace("#n#",(e+1).toString())}}return this}}updatePropRenderFollowers(){const t=jQuery(Show.selectorsCSS.followers);if(0<t.length){let e=this.followers.toString()+" membre"+(1<this.followers?"s":"");if(t.attr("title",e),1e3<=this.followers){const s=Math.round(this.followers/1e3);e=s.toString()+"K membres"}t.text(e)}delete this.__changes.followers}updatePropRenderNbSeasons(){const e=jQuery(Show.selectorsCSS.nbSeasons);0<e.length&&e.text(this.nbSeasons.toString()+" saison"+(1<this.nbSeasons?"s":"")),delete this.__changes.nbSeasons}updatePropRenderNbEpisodes(){const e=jQuery(Show.selectorsCSS.nbEpisodes);0<e.length&&e.text(this.nbEpisodes.toString()+" épisode"+(1<this.nbEpisodes?"s":"")),delete this.__changes.nbEpisodes}updatePropRenderStatus(){const t=jQuery(Show.selectorsCSS.status);if(0<t.length){let e="Terminée";"continuing"===this.status.toLowerCase()&&(e="En cours"),t.text(e)}delete this.__changes.status}updatePropRenderDuration(){const e=jQuery(Show.selectorsCSS.duration);0<e.length&&e.text(this.duration.toString())}init(){if(this.elt){const e=[];return e.push(this.fetchSeasons().then(()=>(this.in_account?this.deleteShowClick():this.addShowClick(),this))),e.push(super.init()),Promise.all(e).then(()=>this)}return super.init()}fetch(e=!0){const t=this;return this.__fetches.show||(this.__fetches.show=Base.callApi("GET","shows","display",{id:this.id},e).then(e=>e).finally(()=>delete t.__fetches.show),this.__fetches.show)}fetchSeasons(){const i=this;if(this.__fetches.seasons)return this.__fetches.seasons;const e={thetvdb_id:this.thetvdb_id};let t=!1;return this.thetvdb_id<=0&&(delete e.thetvdb_id,e.id=this.id,t=!0),this.__fetches.seasons=Base.callApi(HTTP_VERBS.GET,"shows","seasons",e,t).then(t=>{if(i.seasons=[],t?.seasons?.length<=0)return i;var s;for(let e=0;e<t.seasons.length;e++)s=parseInt(t.seasons[e].number,10),i.seasons[s-1]=new Season(t.seasons[e],this);return i}).finally(()=>delete i.__fetches.seasons),this.__fetches.seasons}fetchCharacters(){const s=this;return this.__fetches.characters||(this.__fetches.characters=Base.callApi(HTTP_VERBS.GET,"shows","characters",{thetvdb_id:this.thetvdb_id}).then(t=>{if(s.characters=[],t?.characters?.length<=0)return s;for(let e=0;e<t.characters.length;e++)s.characters.push(new Character(t.characters[e]));return s}).finally(()=>delete s.__fetches.characters),this.__fetches.characters)}getCharacterByName(e){var t=e.toLocaleLowerCase();for(const s of this.characters)if(s.actor.toLocaleLowerCase()===t)return s;return null}fetchPersons(){const s=this;return this.__fetches.persons||(this.__fetches.persons=Base.callApi(HTTP_VERBS.GET,"persons","show",{id:this.id}).then(t=>{if(this.persons=[],t.persons)for(let e=0;e<t.persons.length;e++)s.persons.push(new Person(t.persons[e]));return s}).finally(()=>delete s.__fetches.persons),this.__fetches.persons)}async fetchPersonsFromCharacters(){const s=this,t=(this.characters.length<=0&&await this.fetchCharacters(),[]);for(let e=0;e<s.characters.length;e++)t.push(Person.fetch(s.characters[e].person_id));return Promise.all(t).then(t=>{for(let e=0;e<t.length;e++)t[e]&&s.persons.push(t[e]);return s})}getPersonByName(e){var t=e.toLowerCase();for(const s of this.persons)if(s.name.toLowerCase()===t)return s;return null}getPersonById(e){for(const t of this.persons)if(t.id===e)return t;return null}isEnded(){return"ended"===this.status.toLowerCase()}isArchived(){return this.user.archived}isFavorite(){return this.user.favorited}async isMarkedToSee(){return void 0!==(await Base.gm_funcs.getValue("toSee",{}))[this.id]}addToAccount(){const i=this;return this.in_account?new Promise(e=>e(i)):new Promise((t,s)=>{Base.callApi("POST","shows","show",{id:i.id}).then(e=>{i.fill(e.show),i._callListeners(EventTypes.ADD),i.save(),t(i)},e=>{void 0!==e.code&&2003===e.code&&i.update(!0).then(e=>t(e)),s(e)})})}removeFromAccount(){const i=this;return this.in_account?new Promise((t,s)=>{Base.callApi("DELETE","shows","show",{id:i.id}).then(e=>{i.fill(e.show),i._callListeners(EventTypes.REMOVE),i.save(),t(i)},e=>{void 0!==e.code&&2004===e.code&&i.update(!0).then(e=>t(e)),s(e)})}):new Promise(e=>e(i))}archive(){const i=this;return new Promise((t,s)=>{Media.callApi("POST","shows","archive",{id:i.id}).then(e=>{i.fill(e.show),i.save(),i._callListeners(EventTypes.ARCHIVE),t(i)},e=>{s(e)})})}unarchive(){const i=this;return new Promise((t,s)=>{Media.callApi("DELETE","shows","archive",{id:i.id}).then(e=>{i.fill(e.show),i.save(),i._callListeners(EventTypes.UNARCHIVE),t(i)},e=>{s(e)})})}favorite(){const i=this;return new Promise((t,s)=>{Media.callApi("POST","shows","favorite",{id:i.id}).then(e=>{i.fill(e.show),i.save(),t(i)},e=>{s(e)})})}unfavorite(){const i=this;return new Promise((t,s)=>{Media.callApi("DELETE","shows","favorite",{id:i.id}).then(e=>{i.fill(e.show),i.save(),t(i)},e=>{s(e)})})}update(e=!1,i=Base.noop){const n=this;return new Promise((t,s)=>{n.fetch(e).then(e=>{n.fill(e.show),n.updateRender(()=>{t(n),i(),n._callListeners(EventTypes.UPDATE)})}).catch(e=>{Media.notification("Erreur de récupération de la ressource Show","Show update: "+e),s(e),i()})})}updateRender(t=Base.noop){const s=this;this.updateProgressBar(),this.updateNextEpisode(),this.updateArchived(),this.updateNote();var i=this.objNote;if(Base.debug&&console.log("Next ID et status",{next:this.user.next.id,status:this.status,archived:this.user.archived,note_user:i.user}),0===this.user.remaining&&this.in_account&&0==this.currentSeason.getNbEpisodesUnwatched()){let e=new Promise(e=>e(void 0));this.isEnded()&&!this.isArchived()&&(Base.debug&&console.log("Série terminée, popup confirmation archivage"),e=new Promise(e=>{new PopupAlert({title:"Archivage de la série",text:"Voulez-vous archiver cette série terminée ?",callback_yes:function(){jQuery("#reactjs-show-actions button.btn-archive").trigger("click"),e(void 0)},callback_no:function(){return e(void 0),!0}})})),0===i.user&&(Base.debug&&console.log("Proposition de voter pour la série"),e.then(()=>{let e=!1;new PopupAlert({title:Base.trans("popin.note.title.show"),text:"Voulez-vous noter la série ?",callback_yes:function(){return e=!0},callback_no:function(){return!0},onClose:function(){e&&(s.objNote.updateStars(),s.objNote.createPopupForVote())}})})),e.then(()=>{t()})}else t()}updateProgressBar(){Base.debug&&console.log("updateProgressBar"),jQuery(".progressBarShow").css("width",this.user.status.toFixed(1)+"%")}updateArchived(){Base.debug&&console.log("Show updateArchived");const e=jQuery("#reactjs-show-actions button.btn-archive");this.isArchived()&&0<e.length&&e.trigger("click")}updateNote(){Base.debug&&console.log("Show updateNote"),this.objNote.user&&this._callListeners(EventTypes.NOTE)}updateNextEpisode(e=Base.noop){Base.debug&&console.log("updateNextEpisode");const s=this,t=jQuery("a.blockNextEpisode"),i=function(){let t=0;for(let e=0;e<s.seasons.length;e++)t+=s.seasons[e].getNbEpisodesUnwatched();return t.toString()};if(0<t.length&&this.user.next&&!isNaN(this.user.next.id)){var n=parseInt(this.user.next.code.match(/S\d+/)[0].replace("S",""),10);let e=this.user.next;var a=this.currentSeason?.getNextEpisodeUnwatched();n<this.currentSeason?.number&&a&&(e=new Next({id:a.id,code:a.code,date:a.date,title:a.title,image:""})),Base.debug&&console.log("nextEpisode et show.user.next OK",this.user,e);const o=t.find("img"),l=t.find(".remaining div"),d=o.parent("div"),c=o.attr("height"),h=o.attr("width"),u=`${Base.api.url}/pictures/episodes?key=${Base.userKey}&id=${e.id}&width=${h}&height=`+c;o.remove(),d.append(`<img data-src="${u}" class="js-lazy-image" height="${c}" width="${h}" />`),t.find(".titleEpisode").text(e.code.toUpperCase()+" - "+e.title),t.attr("href",t.attr("href").replace(/s\d{2}e\d{2}/,e.code.toLowerCase())),l.text(l.text().trim().replace(/^\d+/,i()))}else t.length<=0&&this.user.next&&!isNaN(this.user.next.id)?(Base.debug&&console.log("No nextEpisode et show.user.next OK",this.user),n=this,a=""+Base.api.url+`/pictures/episodes?key=${Base.userKey}&id=${n.user.next.id}&width=124&height=70`,r=n.resource_url.split("/").pop(),jQuery(".blockInformations__actions").last().after(`<a href="/episode/${r}/${n.user.next.code.toLowerCase()}" class="blockNextEpisode media">
                ...
                </a>`)):this.user.next&&!isNaN(this.user.next.id)||t.remove();var r;e()}addShowClick(e=!1){const l=this,d=$("#episodes .slide__image");var t;async function s(s){var t=jQuery(".blockInformations__action .dropdown-menu a.header-navigation-item");if(t.length<=3){var i=jQuery('script[id^="/reactjs/"]').get(0).id.split(".")[1],n=s.resource_url.substring(location.origin.length),a=s.title.replace(/"/g,'\\"').replace(/'/g,"\\'");let e=`
                ...
                >
                    ${Base.trans("popup.suggest_show.title",{"%title%":"une série"})}</button>`;jQuery("#similars h2.blockTitle").after(a),l.elt.find(".blockInformations__action .btnMarkToSee").parent().remove(),l.elt.find(".blockInformations__title .fa-clock-o").remove();const o=await Base.gm_funcs.getValue("toSee",{});void 0!==o[l.id]&&(delete o[l.id],Base.gm_funcs.setValue("toSee",o))}l.addEventBtnsArchiveAndFavoris(),l.deleteShowClick()}this.in_account||(jQuery("#reactjs-show-actions").html(`
                <div class="blockInformations__action">
